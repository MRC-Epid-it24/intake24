...
<span class="token punctuation">}</span>
</code></pre></div><ul><li><p><code>userId</code> - Internal Intake24 user ID</p></li><li><p><code>redirect</code> - Redirect URL decoded from the input token</p></li><li><p><code>authToken</code> - Authentication token for the new user</p></li></ul>`,39),r=[p];function o(i,c,u,l,d,h){return n(),s("div",null,r)}var g=e(t,[["render",o]]);export{v as __pageData,g as default};
