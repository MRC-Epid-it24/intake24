import{_ as s,o as a,c as n,Q as o}from"./chunks/framework.52fb8202.js";const h=JSON.parse('{"title":"Food groups","description":"","frontmatter":{},"headers":[],"relativePath":"api/admin/food-groups.md","filePath":"api/admin/food-groups.md"}'),p={name:"api/admin/food-groups.md"},l=o(`<h1 id="food-groups" tabindex="-1">Food groups <a class="header-anchor" href="#food-groups" aria-label="Permalink to &quot;Food groups&quot;">​</a></h1><h2 id="browse-food-groups" tabindex="-1">Browse food groups <a class="header-anchor" href="#browse-food-groups" aria-label="Permalink to &quot;Browse food groups&quot;">​</a></h2><p>Browse paginated food groups list</p><h3 id="request" tabindex="-1">Request <a class="header-anchor" href="#request" aria-label="Permalink to &quot;Request&quot;">​</a></h3><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">GET /api/admin/food-groups</span></span>
