import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.b637c96f.js";const u=JSON.parse('{"title":"Roles","description":"","frontmatter":{},"headers":[],"relativePath":"api/admin/roles.md","filePath":"api/admin/roles.md"}'),p={name:"api/admin/roles.md"},e=l(`<h1 id="roles" tabindex="-1">Roles <a class="header-anchor" href="#roles" aria-label="Permalink to &quot;Roles&quot;">​</a></h1><h2 id="browse-roles" tabindex="-1">Browse roles <a class="header-anchor" href="#browse-roles" aria-label="Permalink to &quot;Browse roles&quot;">​</a></h2><p>Browse paginated role list</p><h3 id="request" tabindex="-1">Request <a class="header-anchor" href="#request" aria-label="Permalink to &quot;Request&quot;">​</a></h3><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">GET /api/admin/roles</span></span>
