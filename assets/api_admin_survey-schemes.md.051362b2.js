import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.8290ef30.js";const h=JSON.parse('{"title":"Survey schemes","description":"","frontmatter":{},"headers":[],"relativePath":"api/admin/survey-schemes.md","filePath":"api/admin/survey-schemes.md"}'),l={name:"api/admin/survey-schemes.md"},p=e(`<h1 id="survey-schemes" tabindex="-1">Survey schemes <a class="header-anchor" href="#survey-schemes" aria-label="Permalink to &quot;Survey schemes&quot;">​</a></h1><h2 id="browse-survey-schemes" tabindex="-1">Browse survey schemes <a class="header-anchor" href="#browse-survey-schemes" aria-label="Permalink to &quot;Browse survey schemes&quot;">​</a></h2><p>Browse paginated survey scheme list</p><h3 id="request" tabindex="-1">Request <a class="header-anchor" href="#request" aria-label="Permalink to &quot;Request&quot;">​</a></h3><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">GET /api/admin/survey-schemes</span></span>
