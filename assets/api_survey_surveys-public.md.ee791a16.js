...
<span class="token punctuation">[</span>
  <span class="token punctuation">{</span>
    ...
    <span class="token property">&quot;slug&quot;</span><span class="token operator">:</span> string<span class="token punctuation">,</span>
    ...
    <span class="token property">&quot;originatingUrl&quot;</span><span class="token operator">:</span> string | <span class="token null keyword">null</span><span class="token punctuation">,</span>
    <span class="token property">&quot;supportEmail&quot;</span><span class="token operator">:</span> string<span class="token punctuation">,</span>
    <span class="token property">&quot;openAccess&quot;</span><span class="token operator">:</span> boolean<span class="token punctuation">,</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
...
<span class="token punctuation">}</span>
</code></pre></div><ul><li><p><code>userId</code> - Internal Intake24 user ID</p></li><li><p><code>redirect</code> - Redirect URL decoded from the input token</p></li><li><p><code>authToken</code> - Authentication token for the new user</p></li></ul>`,39),o=[p];function r(c,i,u,l,d,h){return n(),s("div",null,o)}var g=e(t,[["render",r]]);export{y as __pageData,g as default};
