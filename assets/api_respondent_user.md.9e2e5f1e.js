import{_ as s,c as n,o as a,a as t}from"./app.41bcad43.js";const q='{"title":"User","description":"","frontmatter":{},"headers":[{"level":2,"title":"Feedback download","slug":"feedback-download"},{"level":3,"title":"Request","slug":"request"},{"level":3,"title":"Response","slug":"response"},{"level":2,"title":"Get physical data","slug":"get-physical-data"},{"level":3,"title":"Request","slug":"request-1"},{"level":3,"title":"Response","slug":"response-1"},{"level":2,"title":"Update physical data","slug":"update-physical-data"},{"level":3,"title":"Request","slug":"request-2"},{"level":3,"title":"Response","slug":"response-2"},{"level":2,"title":"Submissions","slug":"submissions"},{"level":3,"title":"Request","slug":"request-3"},{"level":3,"title":"Response","slug":"response-3"},{"level":2,"title":"Update password","slug":"update-password"},{"level":3,"title":"Request","slug":"request-4"},{"level":3,"title":"Response","slug":"response-4"}],"relativePath":"api/respondent/user.md"}',p={},e=t(`<h1 id="user" tabindex="-1">User <a class="header-anchor" href="#user" aria-hidden="true">#</a></h1><p>User API endpoints accessible to authentication user.</p><h2 id="feedback-download" tabindex="-1">Feedback download <a class="header-anchor" href="#feedback-download" aria-hidden="true">#</a></h2><p>Download feedback as PDF. Returns stream as <code>application/pdf</code>.</p><h3 id="request" tabindex="-1">Request <a class="header-anchor" href="#request" aria-hidden="true">#</a></h3><div class="language-http"><pre><code>GET /api/user/feedback?survey={survey-slug}
...
</code></pre></div><h2 id="get-physical-data" tabindex="-1">Get physical data <a class="header-anchor" href="#get-physical-data" aria-hidden="true">#</a></h2><p>Get user&#39;s physical data.</p><h3 id="request-1" tabindex="-1">Request <a class="header-anchor" href="#request-1" aria-hidden="true">#</a></h3><div class="language-http"><pre><code>GET /api/user/physical-data
...
</code></pre></div>`,32),o=[e];function r(u,c,l,i,k,d){return a(),n("div",null,o)}var y=s(p,[["render",r]]);export{q as __pageData,y as default};
