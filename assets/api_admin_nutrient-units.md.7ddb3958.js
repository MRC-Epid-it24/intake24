import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.8290ef30.js";const h=JSON.parse('{"title":"Nutrient units","description":"","frontmatter":{},"headers":[],"relativePath":"api/admin/nutrient-units.md","filePath":"api/admin/nutrient-units.md"}'),l={name:"api/admin/nutrient-units.md"},p=e(`<h1 id="nutrient-units" tabindex="-1">Nutrient units <a class="header-anchor" href="#nutrient-units" aria-label="Permalink to &quot;Nutrient units&quot;">​</a></h1><h2 id="browse-nutrient-units" tabindex="-1">Browse nutrient units <a class="header-anchor" href="#browse-nutrient-units" aria-label="Permalink to &quot;Browse nutrient units&quot;">​</a></h2><p>Browse paginated nutrient unit list</p><h3 id="request" tabindex="-1">Request <a class="header-anchor" href="#request" aria-label="Permalink to &quot;Request&quot;">​</a></h3><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">GET /api/admin/nutrient-units</span></span>
