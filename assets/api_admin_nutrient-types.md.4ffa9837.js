import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.a06c5a24.js";const h=JSON.parse('{"title":"Nutrient types","description":"","frontmatter":{},"headers":[],"relativePath":"api/admin/nutrient-types.md","filePath":"api/admin/nutrient-types.md"}'),l={name:"api/admin/nutrient-types.md"},p=e(`<h1 id="nutrient-types" tabindex="-1">Nutrient types <a class="header-anchor" href="#nutrient-types" aria-label="Permalink to &quot;Nutrient types&quot;">​</a></h1><h2 id="browse-nutrient-types" tabindex="-1">Browse nutrient types <a class="header-anchor" href="#browse-nutrient-types" aria-label="Permalink to &quot;Browse nutrient types&quot;">​</a></h2><p>Browse paginated nutrient type list</p><h3 id="request" tabindex="-1">Request <a class="header-anchor" href="#request" aria-label="Permalink to &quot;Request&quot;">​</a></h3><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">GET /api/admin/nutrient-types</span></span>
