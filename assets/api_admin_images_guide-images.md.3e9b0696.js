import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.b637c96f.js";const g=JSON.parse('{"title":"Guide images","description":"","frontmatter":{},"headers":[],"relativePath":"api/admin/images/guide-images.md","filePath":"api/admin/images/guide-images.md"}'),p={name:"api/admin/images/guide-images.md"},o=l(`<h1 id="guide-images" tabindex="-1">Guide images <a class="header-anchor" href="#guide-images" aria-label="Permalink to &quot;Guide images&quot;">​</a></h1><h2 id="browse-guide-images" tabindex="-1">Browse guide images <a class="header-anchor" href="#browse-guide-images" aria-label="Permalink to &quot;Browse guide images&quot;">​</a></h2><p>Browse paginated guide image list</p><h3 id="request" tabindex="-1">Request <a class="header-anchor" href="#request" aria-label="Permalink to &quot;Request&quot;">​</a></h3><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">GET /api/admin/images/guide-images</span></span>
