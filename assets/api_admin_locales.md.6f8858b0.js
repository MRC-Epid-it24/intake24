import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.a06c5a24.js";const q=JSON.parse('{"title":"Locales","description":"","frontmatter":{},"headers":[],"relativePath":"api/admin/locales.md","filePath":"api/admin/locales.md"}'),p={name:"api/admin/locales.md"},o=l(`<h1 id="locales" tabindex="-1">Locales <a class="header-anchor" href="#locales" aria-label="Permalink to &quot;Locales&quot;">​</a></h1><h2 id="browse-locales" tabindex="-1">Browse locales <a class="header-anchor" href="#browse-locales" aria-label="Permalink to &quot;Browse locales&quot;">​</a></h2><p>Browse paginated locale list</p><h3 id="request" tabindex="-1">Request <a class="header-anchor" href="#request" aria-label="Permalink to &quot;Request&quot;">​</a></h3><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">GET /api/admin/locales</span></span>
