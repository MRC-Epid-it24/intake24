...
<span class="token punctuation">}</span>
</span></code></pre></div><p>where:</p><p><strong>slug</strong> is the survey ID,</p><p><strong>name</strong> and <strong>phone</strong> are the respondent&#39;s contact details (as entered into the assistance request form by the respondent).</p><h3 id="response-6" tabindex="-1">Response <a class="header-anchor" href="#response-6" aria-hidden="true">#</a></h3><div class="language-json"><pre><code><span class="token number">200</span> OK
</code></pre></div>`,58),p=[o];function r(l,u,c,i,d,h){return n(),e("div",null,p)}var y=s(t,[["render",r]]);export{v as __pageData,y as default};
