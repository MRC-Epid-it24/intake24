...
</code></pre></div><p>Unit tests in <code>apps</code> folders</p><p>Use following commands to run unit tests across repository and trigger tests in <code>__tests__</code> folders and <code>__tests__/unit</code> folders for package and apps, respectively. <code>Jest</code> will search for all files with <code>.spec.ts</code> extension.</p><div class="language-"><pre><code>pnpm test:unit

pnpm test:unit:watch
</code></pre></div><p>Integration tests can be run with following commands. At the moment, there are only API Server integration tests, so it re-triggers the api internal npm command.</p><div class="language-"><pre><code>pnpm test:integration
...
</code></pre></div>`,28),d=[a];function r(i,c,p,l,u,_){return s(),t("div",null,d)}var m=e(o,[["render",r]]);export{h as __pageData,m as default};
