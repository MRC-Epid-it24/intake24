...
const feedbackSchemes: LocaleMessageObject = {
  ...
  meals: {
    ...
    title: 'Meals',
    tab: 'Meals',
    chart: 'Meal breakdown chart',
    table: 'Meal summary table',
    colors: {
      _: 'Meal color',
      title: 'Meal colors',
    },
    fields: {
      ...
      reset: {
        _: 'Reset meal fields',
        text: 'Reset meal fields to default list',
      },
      id: 'Field ID',
      header: 'Field header',
      value: 'Field value',
      types: {
        ...
        minutes: 'Meal time minutes',
        duration: 'Meal duration',
      },
      validation: {
        required: 'Field must be filled in.',
        unique: 'Field already exists in current list.',
      },
    },
  },
