import type { LocaleMessageValue, useI18n } from 'vue-i18n';
...
export function createTranslate(i18n: ReturnType<typeof useI18n<any, 'en'>>) {
  return (
...
export function createTranslatePath(i18n: ReturnType<typeof useI18n<any, 'en'>>) {
  return (
    path: string,
    params: Dictionary<string | number> = {},
