...
See also [get guide image data](http://localhost:8300/api/respondent/food-data.html#get-guide-image-data) API function 
...
See also [get sliding scale data](http://localhost:8300/api/respondent/food-data.html#get-drink-scale-data) API function 
