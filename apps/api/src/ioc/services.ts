...
import cachedParentCategoriesService from '@intake24/api/services/foods/cached-parent-categories-service';
...
export default (container: AwilixContainer): void => {
  container.register({
    ...
    globalFoodsService: asFunction(globalFoodsService),
