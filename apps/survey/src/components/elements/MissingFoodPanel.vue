<template>
  <v-expand-transition>
    <v-card v-show="modelValue" ref="card" border color="grey-lighten-4">
      ...
      <v-card-text class="pt-0 d-flex flex-column flex-md-row flex-wrap ga-3">
        <v-btn
          color="primary"
          size="large"
        ...
        <v-btn color="primary" size="large" :title="i18n['missing.report']" variant="outlined" @click.stop="confirm">
