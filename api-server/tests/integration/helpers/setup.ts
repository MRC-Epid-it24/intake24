...
export const setupPermissions = async (): Promise<void> => {
  const permissions = [
    ...
    { name: 'as-served-detail', displayName: 'Read as server images' },
    ...
    { name: 'scheme-questions-detail', displayName: 'Read scheme questions' },
    ...
    { name: 'sign-in-logs-detail', displayName: 'Read sign-in logs' },
