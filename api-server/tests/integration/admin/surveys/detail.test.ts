...
export default (): void => {
  ...
  it(`should return 403 when missing 'surveys-detail' permission (surveyadmin)`, async () => {
  ...
  it(`should return 403 when missing 'surveys-detail' permission (surveyStaff)`, async () => {
  ...
  it('should return 200 and data/refs (surveyStaff)', async () => {
    await setPermission(['surveys-detail', surveyStaff(survey.id)]);
