module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const resourcePerms = [
      ...
      { name: 'users-browse', display_name: 'List users' },
      ...
      { name: 'roles-browse', display_name: 'List roles' },
      ...
      { name: 'permissions-browse', display_name: 'List permissions' },
      ...
      { name: 'languages-browse', display_name: 'List languages' },
      ...
      { name: 'locales-browse', display_name: 'List locales' },
      ...
      { name: 'schemes-browse', display_name: 'List schemes' },
      ...
      { name: 'surveys-browse', display_name: 'List surveys' },
      ...
      { name: 'tasks-browse', display_name: 'List tasks' },
