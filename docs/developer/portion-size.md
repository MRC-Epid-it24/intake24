...
documentation](/api/survey/food-data.html) for the related API functions and data structure description.
...
See also the [get food data](/api/survey/food-data.html#get-food-data) API function and the
...
See also [get as served data](/api/survey/food-data.html#get-as-served-image-set-data) API function
...
See also [get guide image data](/api/survey/food-data.html#get-guide-image-data) API function
...
See also [get sliding scale data](/api/survey/food-data.html#get-drink-scale-data) API function
